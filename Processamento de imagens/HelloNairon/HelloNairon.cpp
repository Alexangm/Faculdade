...
int main()
{
    ...
    imwrite("C:\\Users\\Alexsander\\Desktop\\Processamento\\Arte Abstrata.jpg", imagem);
    std::string imgatt = "C:\\Users\\Alexsander\\Desktop\\Processamento\\Arte Abstrata.jpg";
    Mat image_gray;
    image_gray = imread(imgatt, IMREAD_GRAYSCALE);
    imshow("Cinzeiro", image_gray);
    imwrite("C:\\Users\\Alexsander\\Desktop\\Processamento\\Cinzeiro.jpg", image_gray);
    waitKey(0);
    return 0;
}