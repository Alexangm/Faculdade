...
public class ViewIndexPaciente extends javax.swing.JInternalFrame {

    TableModel tb = null;
    PacienteController pc = new PacienteController();
    
    public ViewIndexPaciente() {
        initComponents();
        tb = pc.index();
        tablePacientes.setModel(tb);
        tableDataConsulta.setModel(pc.findConsulta("-1"));
    }
    ...
    private void initComponents() {
        ...
        tableDataConsulta = new javax.swing.JTable();
        ...
        tableDataConsulta.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jScrollPane3.setViewportView(tableDataConsulta);
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(txtGenero, javax.swing.GroupLayout.PREFERRED_SIZE, 84, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void tablePacientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablePacientesMouseClicked
        ...
        txtId.setText(tablePacientes.getModel().getValueAt(linha, 0).toString());
        txtNome.setText(tablePacientes.getModel().getValueAt(linha, 1).toString());
        txtIdade.setText(tablePacientes.getModel().getValueAt(linha, 2).toString());
        txtCpf.setText(tablePacientes.getModel().getValueAt(linha, 3).toString());
        txtGenero.setText(tablePacientes.getModel().getValueAt(linha, 4).toString());

        tableDataConsulta.setModel(pc.findConsulta(txtId.getText()));
    }//GEN-LAST:event_tablePacientesMouseClicked

    private void txtBuscaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscaKeyReleased
        tablePacientes.setModel(pc.findName(txtBusca.getText()));
    ...
    private javax.swing.JTable tableDataConsulta;
