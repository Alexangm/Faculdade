...
public class ViewDelProduto extends javax.swing.JInternalFrame {

    ProdutoController pc = new ProdutoController();
    
    public ViewDelProduto() {
        initComponents();
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if(!"".equals(txtId.getText())) {
            pc.delete(Integer.parseInt(txtId.getText()));
    ...
    private void txtIdKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIdKeyReleased
        if(!"".equals(txtId.getText())) txtNome.setText(pc.findProdutoById(Integer.parseInt(txtId.getText())).get(0).toString());
